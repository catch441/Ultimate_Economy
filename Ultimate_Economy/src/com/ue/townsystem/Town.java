...
public class Town {
	 ...
	 * @throws TownSystemException
	 */
	public File setPlotForSale(File file, double salePrice, String player, Location location)
			throws TownSystemException {
	 ...
	 */
	public File addCoOwner(File file, String coOwner) throws TownSystemException, PlayerException {
	 ...
	 * @throws TownSystemException 
	 */
	public File decreaseTownBankAmount(File file, double amount) throws TownSystemException {
	 ...
	 * @throws TownSystemException
	 */
	public static Town loadTown(File file,Server server, String townName) throws TownSystemException {
		FileConfiguration config = YamlConfiguration.loadConfiguration(file);
		...
		town.setTownSpawn(new Location(server.getWorld(config.getString("World")),
