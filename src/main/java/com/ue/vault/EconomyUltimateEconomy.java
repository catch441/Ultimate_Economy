...
public class EconomyUltimateEconomy implements Economy {
	...
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");

    }

    @Override
    public EconomyResponse bankDeposit(String arg0, double arg1) {
	System.out.println("33 " + arg0 + " " + arg1);
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");
	...
	System.out.println("34 " + arg0 + " " + arg1);
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");
	...
	System.out.println("35 " + arg0 + " " + arg1);
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");
	...
	System.out.println("36 " + arg0 + " " + arg1);
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");
    }
	...
	System.out.println("37 " + arg0 + " " + arg1);
	return new EconomyResponse(0, 0, ResponseType.NOT_IMPLEMENTED,
		"Ultimate_Economy does not support bank accounts!");
    }
