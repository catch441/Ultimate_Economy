	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if (label.equals("ue-config")) {
			if (args.length != 0) {
					...
					switch (args[0]) {
						case "language":
							if (args.length == 3) {
								...
								sender.sendMessage("/ue-config language <language> <country>");
							}
							break;
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						case "maxHomes":
							if (args.length == 2) {
								...
								sender.sendMessage("/ue-config maxHomes <number>");
							}
							break;
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						case "maxRentedDays":
							if (args.length == 2) {
								...
								sender.sendMessage("/ue-config maxRentedDays <number>");
							}
							break;
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						case "maxJobs":
							if (args.length == 2) {
								...
								sender.sendMessage("/ue-config maxJobs <number>");
							}
							break;
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						case "maxJoinedTowns":
							if (args.length == 2) {
								...
								sender.sendMessage("/ue-config maxJoinedTowns <number>");
							}
							break;
						//////////////////////////////////////////////////////////////////////////////////////////////////////////////
						case "homes":
							if (args.length == 2) {
								if (args[1].equals("true") || args[1].equals("false")) {
									...
									sender.sendMessage("/ue-config homes <true/false>");
								}
							} else {
								sender.sendMessage("/ue-config homes <true/false>");
							}
						...
						default:
							sender.sendMessage(
									"/ue-config <language/maxHomes/homes/maxRentedDays/maxJobs/maxJoinedTowns>");
					}
				...
				sender.sendMessage("/ue-config <language/maxHomes/homes/maxRentedDays/maxJobs/maxJoinedTowns>");
			}
		}
		return false;
	}
